...
public class RobotContainer {
    ...
    private final Trigger autoAlignAlgaeTrigger = secondaryController.a();
    ...
    //simulation
    // private final ElevatorArmSimulation elevatorArmSimulation = new ElevatorArmSimulation(elevator, coralManipulator);
    ...
    private void configureBindings() {
        ...
        autoAlignAlgaeTrigger.whileTrue(new AutoAlignAlgae(drivetrain, algaeIntake, led, photonVision));
